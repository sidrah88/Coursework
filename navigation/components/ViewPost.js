...
class ViewPost extends Component {
    ...
    async getSinglePost() {
        ...
        // get request sent to the API to view a single post
    ...
    async updatePost(post_id) {
        ...
        // patch request sent to the API to update a users post
        // uses the postID key to get the current post
        return fetch("http://localhost:3333/api/1.0.0/user/" + id_user + "/post/" + this.props.route.params.postId, {
            method: 'PATCH',
            headers: {
                "X-Authorization": token,
    ...
    async deletePost() {
        ...
        // delete request sent to the API to delete a post 
        return fetch("http://localhost:3333/api/1.0.0/user/" + id_user + "/post/" + this.props.route.params.postId, {
            method: 'delete',
            headers: {
                "X-Authorization": token,
